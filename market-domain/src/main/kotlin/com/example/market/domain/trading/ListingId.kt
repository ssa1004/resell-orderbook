 ...
 */
data class ListingId(@get:JvmName("value") val value: UUID) {

    override fun toString(): String = value.toString()

    companion object {
        @JvmStatic
        fun newId(): ListingId = ListingId(UUID.randomUUID())

        @JvmStatic
        fun of(s: String): ListingId = ListingId(UUID.fromString(s))
    }
}
