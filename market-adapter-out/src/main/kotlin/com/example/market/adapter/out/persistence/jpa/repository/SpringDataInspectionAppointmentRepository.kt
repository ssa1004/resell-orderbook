...
interface SpringDataInspectionAppointmentRepository :
    JpaRepository<InspectionAppointmentJpaEntity, UUID> {
    ...
    fun countActiveBookings(
        ...
        @Param("slotStart") slotStart: Instant,
    ): Long
    ...
    fun countActiveBookingsInRange(
        @Param("centerId") centerId: UUID,
    ...
    fun findActiveByTrade(@Param("tradeId") tradeId: UUID): List<InspectionAppointmentJpaEntity>
}
