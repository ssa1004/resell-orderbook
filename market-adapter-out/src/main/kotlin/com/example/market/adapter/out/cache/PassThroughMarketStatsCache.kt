 ...
 *
 * `market.cache.redis-enabled=false` 일 때 활성. dev 환경은 인스턴스 1대 + 트래픽 적음 →
 * DB 가 충분히 빠르므로 캐시가 굳이 필요 없다. 운영에서는 [TwoTierMarketStatsCache] 가 활성.
 */
@Component
...
class PassThroughMarketStatsCache : MarketStatsCache {
