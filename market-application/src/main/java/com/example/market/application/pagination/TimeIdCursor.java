 ...
 *
 * <p>복합 키인 이유 — 같은 millisecond 에 생성된 두 row 가 있을 수 있어 시간만으로는 결정성을
 ...
 * </pre>
 *
 * <p>{@code N+1} 행을 가져와 {@code N+1} 번째가 있으면 다음 페이지가 있다고 판단하고, 그것을
 * 자르고 N 개만 반환한다. 마지막 페이지는 {@code N} 행 이하 — nextCursor 는 null.</p>
 *
